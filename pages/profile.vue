      ...
      <v-col lg="4" sm="6" xs="12">
        ...
        >
          ...
          <v-card-title
            ...
            >First Name : {{ user.firstName }}</v-card-title
          >
          <v-card-subtitle
            class="my-0"
            style="text-align: center"
            v-model="editedItem.lastName"
            >Last Name :{{ user.lastName }}</v-card-subtitle
          >
          <v-card-subtitle
            class="my-0"
            style="text-align: center"
            v-model="editedItem.phoneNumber"
            >Phone Number :{{ user.phoneNumber }}</v-card-subtitle
          >
